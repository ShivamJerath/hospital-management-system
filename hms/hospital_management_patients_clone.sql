...
--
-- Table structure for table `patients_clone`
--

DROP TABLE IF EXISTS `patients_clone`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `patients_clone` (
